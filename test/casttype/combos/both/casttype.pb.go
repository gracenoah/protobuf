...
import (
	...
	github_com_gogo_protobuf_protoc_gen_gogo_descriptor "github.com/gracenoah/protobuf/protoc-gen-gogo/descriptor"
	github_com_gogo_protobuf_sortkeys "github.com/gracenoah/protobuf/sortkeys"
	github_com_gogo_protobuf_test_casttype "github.com/gracenoah/protobuf/test/casttype"
	io "io"
	io_ioutil "io/ioutil"
	math "math"
	math_bits "math/bits"
...
type Castaway struct {
	...
	MyUint64Ptr          *github_com_gogo_protobuf_test_casttype.MyUint64Type                                                        `protobuf:"varint,3,opt,name=MyUint64Ptr,casttype=github.com/gracenoah/protobuf/test/casttype.MyUint64Type" json:"MyUint64Ptr,omitempty"`
	MyUint64             github_com_gogo_protobuf_test_casttype.MyUint64Type                                                         `protobuf:"varint,4,opt,name=MyUint64,casttype=github.com/gracenoah/protobuf/test/casttype.MyUint64Type" json:"MyUint64"`
	MyFloat32Ptr         *github_com_gogo_protobuf_test_casttype.MyFloat32Type                                                       `protobuf:"fixed32,5,opt,name=MyFloat32Ptr,casttype=github.com/gracenoah/protobuf/test/casttype.MyFloat32Type" json:"MyFloat32Ptr,omitempty"`
	MyFloat32            github_com_gogo_protobuf_test_casttype.MyFloat32Type                                                        `protobuf:"fixed32,6,opt,name=MyFloat32,casttype=github.com/gracenoah/protobuf/test/casttype.MyFloat32Type" json:"MyFloat32"`
	MyFloat64Ptr         *github_com_gogo_protobuf_test_casttype.MyFloat64Type                                                       `protobuf:"fixed64,7,opt,name=MyFloat64Ptr,casttype=github.com/gracenoah/protobuf/test/casttype.MyFloat64Type" json:"MyFloat64Ptr,omitempty"`
	MyFloat64            github_com_gogo_protobuf_test_casttype.MyFloat64Type                                                        `protobuf:"fixed64,8,opt,name=MyFloat64,casttype=github.com/gracenoah/protobuf/test/casttype.MyFloat64Type" json:"MyFloat64"`
	MyBytes              github_com_gogo_protobuf_test_casttype.Bytes                                                                `protobuf:"bytes,9,opt,name=MyBytes,casttype=github.com/gracenoah/protobuf/test/casttype.Bytes" json:"MyBytes,omitempty"`
	NormalBytes          []byte                                                                                                      `protobuf:"bytes,10,opt,name=NormalBytes" json:"NormalBytes,omitempty"`
	MyUint64S            []github_com_gogo_protobuf_test_casttype.MyUint64Type                                                       `protobuf:"varint,11,rep,name=MyUint64s,casttype=github.com/gracenoah/protobuf/test/casttype.MyUint64Type" json:"MyUint64s,omitempty"`
	MyMap                github_com_gogo_protobuf_test_casttype.MyMapType                                                            `protobuf:"bytes,12,rep,name=MyMap,casttype=github.com/gracenoah/protobuf/test/casttype.MyMapType" json:"MyMap,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
	MyCustomMap          map[github_com_gogo_protobuf_test_casttype.MyStringType]github_com_gogo_protobuf_test_casttype.MyUint64Type `protobuf:"bytes,13,rep,name=MyCustomMap,castkey=github.com/gracenoah/protobuf/test/casttype.MyStringType,castvalue=github.com/gracenoah/protobuf/test/casttype.MyUint64Type" json:"MyCustomMap,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
	MyNullableMap        map[github_com_gogo_protobuf_test_casttype.MyInt32Type]*Wilson                                              `protobuf:"bytes,14,rep,name=MyNullableMap,castkey=github.com/gracenoah/protobuf/test/casttype.MyInt32Type" json:"MyNullableMap,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	MyEmbeddedMap        map[github_com_gogo_protobuf_test_casttype.MyInt32Type]Wilson                                               `protobuf:"bytes,15,rep,name=MyEmbeddedMap,castkey=github.com/gracenoah/protobuf/test/casttype.MyInt32Type" json:"MyEmbeddedMap" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	String_              *github_com_gogo_protobuf_test_casttype.MyStringType                                                        `protobuf:"bytes,16,opt,name=String,casttype=github.com/gracenoah/protobuf/test/casttype.MyStringType" json:"String,omitempty"`
