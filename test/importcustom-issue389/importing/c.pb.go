...
import (
	...
	_ "github.com/gracenoah/protobuf/test/importcustom-issue389/imported"
	github_com_gogo_protobuf_test_importcustom_issue389_imported "github.com/gracenoah/protobuf/test/importcustom-issue389/imported"
	io "io"
	math "math"
	math_bits "math/bits"
)
...
type C struct {
	F2                   *github_com_gogo_protobuf_test_importcustom_issue389_imported.B `protobuf:"bytes,1,opt,name=f2,proto3,customtype=github.com/gracenoah/protobuf/test/importcustom-issue389/imported.B" json:"f2,omitempty"`
